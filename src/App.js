      ...
      <Paper elevation={4} style={{minHeight: "100vh", borderRadius: "0px"}}>
        <div className="App">
          ...
          <Routes>
            ...
            <Route path="/colorgame" element={<Colourgame />} />
            <Route path='/movies/add' element={<Createandupdate movies={movies}  setMovies={setMovies}/>} />
            <Route path='/movies' element={<Showmovies movies={movies}/>} />
            <Route path='/tic-tac-toe' element={<TicTacToe />} />
            <Route path="*" element={<Notfound />} />
            <Route path='/movies/:id' element={<Movieadditionalinfo movieli={movies} />}/>
          </Routes>
